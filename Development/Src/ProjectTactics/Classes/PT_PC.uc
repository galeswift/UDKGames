...
ignores SeePlayer, HearNoise, Bump;
	...
	function PlayerMove(float DeltaTime)
	{
		...
		GetAxes(PTGame.MainCamera.Rotation,X,Y,Z);
		...
		if( PTGame != none && PTGame.MainCamera != none )
		{
			...
			{
				Pawn.Velocity = PTGame.MainMover.Velocity;
			}
		}
		else 
		{
		...
		//`log("PTGame.MainMover.Velocity is "@PTGame.MainMover.Velocity@" Pawn velocity"@Pawn.Velocity);
		// Update rotation.
