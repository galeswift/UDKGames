...
class SeqAct_SpawnCustomProjectile extends SequenceAction;

/** Class of projectile to spawn */
var() class<Projectile> ProjectileClass;

var Actor SpawnedProjectile;
...
{
	bCallHandler=false
	ObjName="Spawn Custom Projectile"
	...
	VariableLinks(3)=(ExpectedType=class'SeqVar_Object',LinkDesc="Projectile",bWriteable=true,PropertyName=SpawnedProjectile)
}
